...
- **Since this is a list, I need at least two items.**
  ...
  I explained what I was doing already in the previous list item, but a list wouldn't be a list if it only had one item, and we really want this to look realistic. That's why I've added this second list item so I actually have something to look at when writing the styles.
...
3.  **Two items aren't really a list, three is good though.**
